class ArticlesController < ApplicationController
  ...
  def insert_big_tag (object, type)
    ...
    case type
      when 1
        position = "#{object.part_index}_0_0_0_0_0"
        insert_html_tag(object.name_part,object.name_part,position,'part_index',true)
      when 2
        position = "#{object.part_index}_#{object.chap_index}_0_0_0_0"
        insert_html_tag(object.chap_name,object.chap_name,position,'chap_index',true)
      when 3
        position = "#{object.part_index}_#{object.chap_index}_#{object.sec_index}_0_0_0"
        insert_html_tag(object.sec_name,object.sec_name,position,'sec_index',true)
      when 4
        position = "#{object.part_index}_#{object.chap_index}_#{object.sec_index}_#{object.law_index}_0_0"
  ...
  def insert_small_tag (object, type)
    ...
    case type
      when 1
        position = "#{object.part_index}_#{object.chap_index}_#{object.sec_index}_#{object.law_index}_#{object.item_index}_0"
        insert_html_tag(firstStrip(object.item_content) ,object.item_name,position,'item_index', false)
      when 2
        position = "#{object.part_index}_#{object.chap_index}_#{object.sec_index}_#{object.law_index}_#{object.item_index}_#{object.point_index}"
  ...
  def insert_html_tag (string, name, position, type, style)
    ...
    if find != nil
      ...
      @full_html = @full_html[0,find.begin(0)] + html_insert + @full_html[find.begin(0),@full_html.length]
      if style == true
